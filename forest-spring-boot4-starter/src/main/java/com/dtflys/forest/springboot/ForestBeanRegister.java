...
public class ForestBeanRegister implements ResourceLoaderAware, BeanPostProcessor {
    ...
    public ForestConfiguration registerForestConfiguration() {
        ...
        beanDefinitionBuilder
                ...
                .addPropertyValue("asyncRejectPolicyClass", forestConfigurationProperties.getAsyncRejectPolicyClass())
                ...
                .addPropertyValue("logRequestHeaders", forestConfigurationProperties.isLogRequestHeaders())
                .addPropertyValue("logRequestBody", forestConfigurationProperties.isLogRequestBody())
                .addPropertyValue("logResponseStatus", forestConfigurationProperties.isLogResponseStatus())
                .addPropertyValue("logResponseHeaders", forestConfigurationProperties.isLogResponseHeaders())
                ...
                .addPropertyValue("backendClientCacheExpireTime", forestConfigurationProperties.getBackendClientCacheExpireTime())
